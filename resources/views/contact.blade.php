...
<body>
    ...
    <script>
        ...
        // The theme's main.js intercepts .contact-form submit via AJAX without
        // a CSRF token, causing Laravel to reject the request with 419.
        // Remove the theme's handler so the form submits natively, which
        // includes the _token field generated by @csrf.
        $(function() {
            $('form.contact-form').off('submit');
        });
    </script>
